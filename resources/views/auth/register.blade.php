            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('chefia') ? ' has-error' : '' }}">
                            <label for="chefia" class="col-md-4 control-label">Chefia Imediata</label>
                            ...
                            <div class="col-md-6">
                                ...
                                @if ($errors->has('chefia'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('chefia') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
